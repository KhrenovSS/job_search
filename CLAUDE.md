...
Письмо предлагает **только работу по ИП** — оговорок про штат в нём нет (`prompts/cover_letter.md`, п.4),
хотя штатная вакансия остаётся полноценным лидом. Деньги — п.5: обе суммы (ориентир в резюме и вилка
в вакансии) объявляются месячным окладом штатного сотрудника, стоимость договора считается от объёма,
сроков и состава задач; **сумм в письме нет никогда** (зарплата вакансии уходит в промпт флагом
`salary_stated`, не числом).
