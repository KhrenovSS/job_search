...
(п.3): «вы проектируете насосные — ПО для КНС и насосных писал на ОВЕН/Schneider с MasterSCADA, беру программную часть
на подряд»; факты — только из `prompts/resume.md`, куда владелец добавил текст своего объявления (24.09).
