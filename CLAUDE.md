...
Деньги в письме — `prompts/cover_letter.md`, п.5: обязательный абзац про то, что ориентир в резюме относится
к штатной позиции, а по договору оплачивается объём; **сумм в письме нет никогда** (зарплата вакансии уходит
в промпт флагом `salary_stated`, не числом).
