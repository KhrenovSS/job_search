...
Каждый день в 12:00 присылает в Telegram **до десяти лидов** (суточная норма `DIGEST_MAX_ITEMS`; не предложить —
гарантированный отказ, поэтому норму подняли с пяти, а окупаемость полос считает `/stats`): вакансии hh.ru, за которыми стоит компания, которой прямо сейчас
