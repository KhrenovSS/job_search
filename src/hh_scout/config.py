...
# Avito (v9.14, заготовка без отдельного решения — парсера нет, только scripts/avito_snapshot.py): один поисковый URL на канал, одна страница за подход. Объявление, услуга и
