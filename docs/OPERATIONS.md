...
| `bash go_hh.sh [ЧЧ:ММ \| YYYY-MM-DD]` | разбор суток одной командой: состояние сервиса (в т.ч. «отправка лидов идёт»), следующий подход и страницы к лимиту, сводка суток, прогоны и отправки за 24 ч, лиды по каналам, отдельная проверка «ушло БЕЗ письма» (должно быть пусто), последние 25 лидов, очередь и пул эксплуатантов, стадии и предупреждения из журнала. Только чтение — можно и во время сбора | — | — |
