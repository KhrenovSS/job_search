...
до триажа и до загрузки страницы; среди оценённых остаётся лучшая по баллу. `/skipped` показывает их с причиной. Ручной `/crawl [N]` и CLI берут весь остаток дня
